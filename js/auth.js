...
async function handleBootstrap(e) {
  ...
  currentUser = { id: row.id, username: row.username, full_name: row.full_name, role: row.role, can_edit_booking_date: row.can_edit_booking_date, can_edit_cp_details: row.can_edit_cp_details };
